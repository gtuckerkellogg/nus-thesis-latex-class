...
\begin{declaration}
  ...
  \DeclarationGenAI           % template B: AI used for language/proofreading
  %\DeclarationGenAI[none]    % template A: no AI used
  %\DeclarationGenAICustom{Custom AI disclosure text here.}
  \DeclarationSignature       % add [./signature2.png] for a signature image
\end{declaration}
